...
/*
 * JUnit test of ArraySearch.lastOccurrenceSearch of a target
 ...
 */
 ...
 //This is the class of ArraySearch for question 2 used for the JUnit test hardness
public class ArraySearchQuestion2Test {
    ...
    public void firstElementTest() {
        assertEquals("5 is not at position 0", 0, ArraySearch.lastOccurrenceSearch(myArray1, 5, 0, 6));
    }

    //The test indicating that the target element is the last element in the array.
    @Test
    public void lastElementTest(){
        assertEquals("7 is not at position 6", 6, ArraySearch.lastOccurrenceSearch(myArray1, 7, 0, 6));
    }

    //The test indicating that the target is somewhere in the middle.
    @Test
    public void inMiddleTest(){
        assertEquals("4 is not found at position 3", 3, ArraySearch.lastOccurrenceSearch(myArray1, 4, 0, 6));
    }

    //The test indicating that the target element is not in the array
    @Test
    public void notInArrayTest(){
        assertEquals("-5 is not in the array", -1, ArraySearch.lastOccurrenceSearch(myArray1, -5, 0, 6));
    }

    //The test indicating that there is more than one occurrence of the target element and we find the last occurrence of the target.
    @Test
    public void multipleOccurencesTest(){
        assertEquals("12 is not found at position 5", 5, ArraySearch.lastOccurrenceSearch(myArray1, 12, 0,6));
    }

    //The tests indicating that the array has only one element and it is not the target.
    @Test
    public void oneElementArrayTestAbsent(){
         assertEquals("-10 is not found in the array", -1, ArraySearch.lastOccurrenceSearch(myArray2, -10, 0, 0));
    }

    //The tests indicating that the array has only one element and it is the target.
    @Test
    public void oneElementArrayTestItemPresent(){
        assertEquals("10 is not found at position 0", 0, ArraySearch.lastOccurrenceSearch(myArray2, 10, 0,0));
    }

    //Test indicating that the array has no element.
    @Test
    public void emptyArrayTest(){
        assertEquals("10 is not in the array", -1, ArraySearch.lastOccurrenceSearch(myArray3, 10, 0, 0));
    }
    ...
    public void NullPointerException(){
        assertEquals(0, ArraySearch.lastOccurrenceSearch(null, 5,0,0));
    }
}
